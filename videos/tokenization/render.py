#!/usr/bin/env python
"""Render every scene of "Tokenization: why the model never reads your words" in order and concatenate to one file.

Usage:
    .venv/bin/python videos/tokenization/render.py               # default profile
    .venv/bin/python videos/tokenization/render.py --profile final
    .venv/bin/python videos/tokenization/render.py --scene SceneName --no-concat
"""
